...
COLLECTORS: dict[str, Collector] = {
    ...
    "chuapp": Collector(
        key="chuapp",
        script=ROOT / "collectors" / "chuapp.py",
        section="industry_news",
        default_max_pages=1,
    ),
    "gameres": Collector(
        key="gameres",
        script=ROOT / "collectors" / "gameres.py",
        section="industry_news",
        default_max_pages=1,
    ),
    "gamespot": Collector(
        key="gamespot",
        script=ROOT / "collectors" / "gamespot.py",
        section="industry_news",
        default_max_pages=1,
    ),
    "ign_cn": Collector(
        key="ign_cn",
        script=ROOT / "collectors" / "ign_cn.py",
        section="industry_news",
        default_max_pages=1,
    ),
    "indienova": Collector(
        key="indienova",
        script=ROOT / "collectors" / "indienova.py",
        section="industry_news",
        default_max_pages=3,
    ),
    "luosiji_sohu": Collector(
        key="luosiji_sohu",
        script=ROOT / "collectors" / "luosiji_sohu.py",
        section="industry_news",
        default_max_pages=5,
    ),
    "pcgamer": Collector(
        key="pcgamer",
        script=ROOT / "collectors" / "pcgamer.py",
        section="industry_news",
        default_max_pages=1,
    ),
    "polygon": Collector(
        key="polygon",
        script=ROOT / "collectors" / "polygon.py",
        section="industry_news",
        default_max_pages=1,
    ),
    "qimai_sohu": Collector(
        key="qimai_sohu",
        script=ROOT / "collectors" / "qimai_sohu.py",
        section="industry_news",
        default_max_pages=5,
    ),
    "yxrb": Collector(
        key="yxrb",
        script=ROOT / "collectors" / "yxrb.py",
        section="industry_news",
        default_max_pages=2,
    ),
    ...
    "baoyu": Collector(
        key="baoyu",
        script=ROOT / "collectors" / "baoyu.py",
        section="ai_trends",
        default_max_pages=1,
    ),
    "unrealengine": Collector(
        key="unrealengine",
        script=ROOT / "collectors" / "unrealengine.py",
        section="ai_trends",
        default_max_pages=1,
    ),
    ...
    "gameoracle": Collector(
        key="gameoracle",
        script=ROOT / "collectors" / "gameoracle.py",
        section="deep_analysis",
        default_max_pages=1,
    ),
    "matthewball": Collector(
        key="matthewball",
        script=ROOT / "collectors" / "matthewball.py",
        section="deep_analysis",
        default_max_pages=1,
    ),
    "necromanov": Collector(
        key="necromanov",
        script=ROOT / "collectors" / "necromanov.py",
        section="deep_analysis",
        default_max_pages=1,
    ),
    "questmobile": Collector(
        key="questmobile",
        script=ROOT / "collectors" / "questmobile.py",
        section="deep_analysis",
        default_max_pages=1,
    ),
    "sensortower": Collector(
        key="sensortower",
        script=ROOT / "collectors" / "sensortower.py",
        section="deep_analysis",
        default_max_pages=1,
    ),
